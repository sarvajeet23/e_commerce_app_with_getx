...
import 'package:e_commerce_app_with_getx/shared/helpers/extensions/StringExtension.dart';
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 8),
                      _buildListTile(
                          'Language', Icons.language, 'English', Colors.orange, theme,
                          onTab: () {}),
                      SizedBox(height: 8),
        ...
        trailing: Container(
          ...
          child: Row(
            ...
            children: [
              Text(trailing,
                  style:
                      theme.textTheme.bodyText1?.copyWith(color: Colors.grey.shade600)),
              Icon(
