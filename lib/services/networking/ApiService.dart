...
class ApiService {
  ...
  Future<JSON> post<T>({
    ...
    final response =
        await _baseProvider.post(endpoint, body, headers: customHeaders, query: query);
  ...
  Future<JSON> put<T>({
    ...
    final response =
        await _baseProvider.put(endpoint, body, headers: customHeaders, query: query);
  ...
  Future<JSON> delete<T>({
    ...
    final response =
        await _baseProvider.delete(endpoint, headers: customHeaders, query: query);
